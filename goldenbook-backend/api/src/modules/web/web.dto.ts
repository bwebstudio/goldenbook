// ─── Web homepage DTOs ────────────────────────────────────────────────────────
// These are UI-ready types consumed exclusively by goldenbook-web.
// All image references are already resolved to full URLs — no bucket/path
// objects leak to the public web layer.
